...
class MyTestCase_CLJK_SBZLGL_Pldc(unittest.TestCase):
    '''车辆监控平台-设备资料管理模块-批量导出测试集'''
    ...
    @BeautifulReport.add_test_img('test_CLJK_SBZLGL_Pldc')
    def test_CLJK_SBZLGL_Pldc(self):
        '''设备资料管理模块-批量导出测试用例'''
        # 点击批量导出
...
if __name__=='__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_CLJK_SBZLGL_Pldc('test_CLJK_SBZLGL_Pldc'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='车辆监控平台-设备资料管理模块-批量导出测试报告',
