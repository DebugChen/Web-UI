...
class MyTestCase_CLJK_SBZLGL_Look(unittest.TestCase):
    '''车辆监控平台-设备资料管理模块-查看测试集'''
    ...
    @BeautifulReport.add_test_img('test_CLJK_SBZLGL_Look')
    def test_CLJK_SBZLGL_Look(self):
        '''设备资料管理模块-查看测试用例'''
        # 输入IMEI
...
if __name__=='__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_CLJK_SBZLGL_Look('test_CLJK_SBZLGL_Look'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='车辆监控平台-设备资料管理模块-查看测试报告',
