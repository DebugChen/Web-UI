...
class MyTestCase_XBDY_Zlxf_Plxfzljgcx(MyTestCase_XBDY_Login_GG):
    '''新北斗云平台-指令下发模块-批量下发指令结果查询测试集'''
    ...
    @BeautifulReport.add_test_img('test_XBDY_Sbjrgl_Plxfzljgcx')
    def test_XBDY_Zlxf_Plxfzljgcx(self):
        '''指令下发模块-批量下发指令结果查询测试用例'''
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_XBDY_Zlxf_Plxfzljgcx('test_XBDY_Zlxf_Plxfzljgcx'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='新北斗云平台-指令下发模块-批量下发指令结果查询测试报告',
