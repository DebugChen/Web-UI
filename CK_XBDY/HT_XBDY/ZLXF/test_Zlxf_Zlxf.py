...
class MyTestCase_XBDY_Zlxf_Zlxf(MyTestCase_XBDY_Login_GG):
    '''新北斗云平台-指令下发模块-指令下发测试集'''
    ...
    @BeautifulReport.add_test_img('test_XBDY_Sbjrgl_Zlxf')
    def test_XBDY_Zlxf_Zlxf(self):
        '''指令下发模块-指令下发测试用例'''
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_XBDY_Zlxf_Zlxf('test_XBDY_Zlxf_Zlxf'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='新北斗云平台-指令下发模块-指令下发测试报告',
