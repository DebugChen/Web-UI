...
class MyTestCase_XBDY_Zlxf_Cksbcs(MyTestCase_XBDY_Login_GG):
    '''新北斗云平台-指令下发模块-查看设备参数测试集'''
    ...
    @BeautifulReport.add_test_img('test_XBDY_Sbjrgl_Cksbcs')
    def test_XBDY_Zlxf_Cksbcs(self):
        '''指令下发模块-查看设备参数测试用例'''
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_XBDY_Zlxf_Cksbcs('test_XBDY_Zlxf_Cksbcs'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='新北斗云平台-指令下发模块-查看设备参数测试报告',
