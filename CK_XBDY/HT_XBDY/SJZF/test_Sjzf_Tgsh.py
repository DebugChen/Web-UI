...
class MyTestCase_XBDY_Sjzf_Tgsh(MyTestCase_XBDY_Login_GG):
    '''新北斗云平台-数据转发模块-通过审核测试集'''
    ...
    @BeautifulReport.add_test_img('test_XBDY_Sjzf_Tgsh')
    def test_XBDY_Sjzf_Tgsh(self):
        '''数据转发模块-通过审核测试用例'''
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_XBDY_Sjzf_Tgsh('test_XBDY_Sblb_Tgsh'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='新北斗云平台-数据转发模块-通过审核测试报告',
