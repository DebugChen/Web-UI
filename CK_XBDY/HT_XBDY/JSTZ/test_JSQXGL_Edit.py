...
class MyTestCase_CLJK_JSQXGL_Edit(unittest.TestCase):
    ...
    def test_CLJK_JSQXGL_Edit1(self):
        ...
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的角色名称"]').send_keys('测试角色3')
        time.sleep(1)
        # 点击查询
        ...
        # 点击编辑
        self.dr.find_element_by_xpath(
            '//table[@class="el-table__body"]/tbody/tr[HT_XBDY]/td[3]/div/button[2]').click()
        time.sleep(2)
        # 修改角色名称
        self.dr.find_element_by_xpath(
        ...
        time.sleep(1)
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入角色名称，不可包含数字和特殊字符"]').send_keys('测试角色33')
        time.sleep(1)
        # 角色状态默认正常
        # 点击提交按钮
        self.dr.find_element_by_xpath(
        ...
        # 判断预期结果与实际结果是否一致
        self.assertEqual(div, '测试角色33', '编辑角色失败')
        time.sleep(1)
        # 点击清除
    ...
    def test_CLJK_JSQXGL_Edit2(self):
        ...
        # 输入角色名称
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的角色名称"]').send_keys('测试角色33')
        time.sleep(1)
        # 点击查询
        self.dr.find_element_by_xpath('//button[@title="搜索"]').click()
        time.sleep(2)
        ...
        time.sleep(1)
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入角色名称，不可包含数字和特殊字符"]').send_keys('测试角色3')
        time.sleep(1)
        # 选择角色状态
        self.dr.find_element_by_xpath(
