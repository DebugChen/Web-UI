...
class MyTestCase_CLJK_KHXXGL_Add(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        #     'C:\\Users\starlinkware\PycharmProjects\\CK_CLJK\LSTZ\image1\KHXXGL_Add.png')
        # 关闭浏览器
        cls.dr.quit()
    ...
    def test_CLJK_KHXXGL_Add1(self):
        ...
        time.sleep(2)
        # 点击新增客户按钮
        self.dr.find_element_by_xpath('//div[@class="btnArrList"]/button[HT_XBDY]').click()
        time.sleep(2)
        # 输入客户名称
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入客户名称，不可包含数字和特殊字符"]').send_keys('测试客户C')
        time.sleep(1)
        # 输入联系人
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入联系人"]').send_keys('测试客户C')
        time.sleep(1)
        # 输入联系电话
        self.dr.find_element_by_xpath(
        ...
        # 输入安装账号
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入安装账号"]').send_keys('测试客户C')
        time.sleep(1)
        # 状态默认：正常
        # 点击提交按钮
        self.dr.find_element_by_xpath(
        ...
        # 输入客户信息
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的客户名称"]').send_keys('测试客户C')
        time.sleep(1)
        # 点击查询按钮
        ...
        # 判断预期结果与实际结果是否一致
        self.assertEqual(div1, '测试客户C', '新增正常状态客户失败')
        time.sleep(1)
        # 获取页面元素，保存到变量
    ...
    def test_CLJK_KHXXGL_Add2(self):
        ...
        # 点击新增客户按钮
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[6]/div[HT_XBDY]/div[2]/button[HT_XBDY]').click()
        time.sleep(2)
        # 输入客户名称
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入客户名称，不可包含数字和特殊字符"]').send_keys('测试客户D')
        time.sleep(1)
        # 输入联系人
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入联系人"]').send_keys('测试客户D')
        time.sleep(1)
        # 输入联系电话
        self.dr.find_element_by_xpath(
        ...
        # 输入安装账号
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入安装账号"]').send_keys('测试客户D')
        time.sleep(1)
        # 选择锁定状态
        self.dr.find_element_by_xpath(
        ...
        # 输入客户信息
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的客户名称"]').send_keys('测试客户D')
        time.sleep(1)
        # 点击查询按钮
        self.dr.find_element_by_xpath('//button[@title="搜索"]').click()
        time.sleep(2)
        ...
        div1 = self.dr.find_element_by_xpath(
            '//table[@class="el-table__body"]/tbody/tr/td[HT_XBDY]/div').text
        # 判断预期结果与实际结果是否一致
        self.assertEqual(div1, '测试客户D', '新增锁定状态客户失败')
        time.sleep(1)
        # 获取页面元素，保存到变量
        div2 = self.dr.find_element_by_xpath(
            '//table[@class="el-table__body"]/tbody/tr/td[6]/div').text
