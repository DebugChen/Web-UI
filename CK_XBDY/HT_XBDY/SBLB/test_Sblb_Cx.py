...
class MyTestCase_XBDY_Sblb_Cx(MyTestCase_XBDY_Login_GG):
    '''新北斗云平台-设备列表模块-查询测试集'''
    ...
    @BeautifulReport.add_test_img('test_XBDY_Sblb_Cx')
    def test_XBDY_Sblb_Cx(self):
        '''设备列表模块-查询测试用例'''
    ...
    # @unittest.skip('跳过用例')
    # 装饰器，当你没有报错也要截图的话，那么你需要在用例里面调用save_img('001')方法
    @BeautifulReport.add_test_img('test_XBDY_Sblb_SBKCZT_Cx')
    def test_XBDY_Sblb_SBKCZT_Cx(self):
        '''设备列表模块-设备入库状态查询测试用例'''
        # self.dr = webdriver.Chrome()
        ...
        self.dr.find_element_by_xpath(
            ...
            '/div[1]/div[2]/div[1]/ul[1]/li/span[2]').click()
        time.sleep(2)
        # 获取页面元素，保存到变量
        span = self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
            '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[9]/div/span').text
        # 判断预期结果与实际结果是否一致
        self.assertEqual(span, '入库', '按设备入库状态查询失败')
        time.sleep(1)
        ...
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[2]/div[1]/ul[2]/li/span[2]').click()
        time.sleep(2)
        # 获取页面元素，保存到变量
        span = self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
            '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[9]/div/span').text
        # 判断预期结果与实际结果是否一致
        self.assertEqual(span, '出库', '按设备入库状态查询失败')
        time.sleep(1)
        ...
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[2]/div[1]/ul[3]/li/span[2]').click()
        time.sleep(2)
        # # 获取页面元素，保存到变量
        # span = self.dr.find_element_by_xpath(
        #     '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
        #     '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[9]/div/span').text
        # # 判断预期结果与实际结果是否一致
        # self.assertEqual(span, '退库', '按设备入库状态查询失败')
        # time.sleep(1)
        ...
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[2]/div[1]/ul[4]/li/span[2]').click()
        time.sleep(2)
        # # 获取页面元素，保存到变量
        # span = self.dr.find_element_by_xpath(
        #     '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
        #     '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[9]/div/span').text
        # # 判断预期结果与实际结果是否一致
        # self.assertEqual(span, '维修', '按设备入库状态查询失败')
        # time.sleep(1)
        ...
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[2]/div[1]/ul[5]/li/span[2]').click()
        time.sleep(2)
        # # 获取页面元素，保存到变量
        # span = self.dr.find_element_by_xpath(
        #     '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
        #     '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[9]/div/span').text
        # # 判断预期结果与实际结果是否一致
        # self.assertEqual(span, '报废', '按设备入库状态查询失败')
        # time.sleep(1)

    # @unittest.skip('跳过用例')
    # 装饰器，当你没有报错也要截图的话，那么你需要在用例里面调用save_img('001')方法
    @BeautifulReport.add_test_img('test_XBDY_Sblb_QTYH_Cx')
    def test_XBDY_Sblb_QTYH_Cx(self):
        '''设备列表模块-前台用户查询测试用例'''
        # self.dr = webdriver.Chrome()
        ...
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[1]/div/div[2]/ul[2]/li[2]').click()
        time.sleep(1)
        # 点击个人用户-测试账户-个人01
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
            '/div[1]/div[2]/div[2]/ul[1]/li/ul[2]/li/span[2]').click()
        time.sleep(2)
        # 点击查看详情
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
            '/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[8]/div/div/button[2]').click()
        time.sleep(1)
        # 切换到用户信息界面
        self.dr.find_element_by_xpath(
            '//div[@class="ivu-modal-wrap vertical-center-modal"]'
        ...
        span = self.dr.find_element_by_xpath(
            '//div[@class="ivu-modal-wrap vertical-center-modal"]'
            '/div/div/div[2]/div/div/div[2]/div[2]/form/div[1]/div[2]/u').text
        # 判断预期结果与实际结果是否一致
        self.assertEqual(span, '测试账户-个人01', '按前台用户查询失败')
        time.sleep(1)
        # 点击关闭
        self.dr.find_element_by_xpath(
            '//div[@class="ivu-modal-wrap vertical-center-modal"]'
    ...
    # @unittest.skip('跳过用例')
    # 装饰器，当你没有报错也要截图的话，那么你需要在用例里面调用save_img('001')方法
    @BeautifulReport.add_test_img('test_XBDY_Sblb_ZDYSBZ_Cx')
    def test_XBDY_Sblb_ZDYSBZ_Cx(self):
        '''设备列表模块-自定义设备组查询测试用例'''
        # self.dr = webdriver.Chrome()
        ...
        self.dr.find_element_by_xpath(
            ...
            '/div[2]/div[3]/div/div[3]/ul[1]/li/ul/li/span[2]').click()
        time.sleep(2)
        # 获取页面元素，保存到变量
        span = self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/div[2]'
        ...
        # 判断预期结果与实际结果是否一致
        self.assertEqual(span, '352736082365209', '按自定义设备组查询失败')
        time.sleep(1)
        # 点击下拉选项
        self.dr.find_element_by_xpath(
            '//*[@id="app"]/div/div[1]/div[2]/div[2]/div[2]/div'
    ...
    # @unittest.skip('跳过用例')
    # 装饰器，当你没有报错也要截图的话，那么你需要在用例里面调用save_img('001')方法
    @BeautifulReport.add_test_img('test_XBDY_Sblb_Fy')
    def test_XBDY_Sblb_Fy(self):
        '''设备列表模块-分页测试用例'''
        # #按50条/页
        # 点击分页显示
        self.dr.find_element_by_xpath(
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_XBDY_Sblb_Cx('test_XBDY_Sblb_Cx'))
    testunit.addTest(MyTestCase_XBDY_Sblb_Cx('test_XBDY_Sblb_SBKCZT_Cx'))
    testunit.addTest(MyTestCase_XBDY_Sblb_Cx('test_XBDY_Sblb_QTYH_Cx'))
    testunit.addTest(MyTestCase_XBDY_Sblb_Cx('test_XBDY_Sblb_ZDYSBZ_Cx'))
    testunit.addTest(MyTestCase_XBDY_Sblb_Cx('test_XBDY_Sblb_Fy'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='新北斗云平台-设备列表模块-查询测试报告',
