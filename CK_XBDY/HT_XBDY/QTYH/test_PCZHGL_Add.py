...
class MyTestCase_CLJK_PCZHGL_Add(unittest.TestCase):
    ...
    def test_CLJK_PCZHGL_Add1(self):
        ...
        # 输入用户账户
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入用户账号"]').send_keys('CSZH004')
        time.sleep(2)
        # 输入用户名
        self.dr.find_element_by_xpath('//input[@placeholder="请输入用户名"]').clear()
        time.sleep(2)
        self.dr.find_element_by_xpath('//input[@placeholder="请输入用户名"]').send_keys('CSZH004')
        time.sleep(2)
        # 输入密码
        self.dr.find_element_by_xpath(
        ...
        time.sleep(2)
        self.dr.find_element_by_xpath(
            '//input[@placeholder="密码必须包含大小写字母和数字(8-16位)"]').send_keys('Douniu2918')
        time.sleep(2)
        # 输入手机号
        self.dr.find_element_by_xpath(
        ...
        # 输入用户账户
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的用户账号"]').send_keys('CSZH004')
        time.sleep(2)
        # 点击查询
        ...
        # 判断预期结果与实际结果是否一致
        self.assertEqual(div1, 'CSZH004', '新增正常PC账户失败')
        time.sleep(1)
        # 获取页面元素，保存到变量
    ...
    def test_CLJK_PCZHGL_Add2(self):
        ...
        # 输入用户账户
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入用户账号"]').send_keys('CSZH003')
        time.sleep(2)
        # 输入用户名
        self.dr.find_element_by_xpath('//input[@placeholder="请输入用户名"]').clear()
        time.sleep(2)
        self.dr.find_element_by_xpath('//input[@placeholder="请输入用户名"]').send_keys('CSZH003')
        time.sleep(2)
        # 输入密码
        self.dr.find_element_by_xpath(
            '//input[@placeholder="密码必须包含大小写字母和数字(8-16位)"]').clear()
        ...
        time.sleep(2)
        # 状态默认：锁定
        self.dr.find_element_by_xpath('//form[@class="el-form"]/div[9]/div/label[2]/span[HT_XBDY]/span').click()
        # 账户有效期至默认：永久有效
        # 选择地图展示位置（湖北省）
        self.dr.find_element_by_xpath('//input[@placeholder="请选择您的地址"]').click()
        self.dr.find_element_by_xpath('//input[@placeholder="请选择您的地址"]').send_keys(Keys.DOWN)
        ...
        # 输入用户账户
        self.dr.find_element_by_xpath(
            '//input[@placeholder="请输入需要搜索的用户账号"]').send_keys('CSZH003')
        time.sleep(2)
        # 点击查询
        self.dr.find_element_by_xpath('//button[@title="搜索"]').click()
        time.sleep(2)
        ...
        div1 = self.dr.find_element_by_xpath(
            '//table[@class="el-table__body"]/tbody/tr[HT_XBDY]/td[2]/div').text
        # 判断预期结果与实际结果是否一致
        self.assertEqual(div1, 'CSZH003', '新增锁定PC账户失败')
        time.sleep(1)
        # 获取页面元素，保存到变量
        div2 = self.dr.find_element_by_xpath(
            '//table[@class="el-table__body"]/tbody/tr[HT_XBDY]/td[5]/div').text
