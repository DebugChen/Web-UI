...
im = open('E:/UIZDH/CK_ZHHL/cde.png', 'rb').read()
...
for l in all_list:
    ...
    time.sleep(0.5)
# 图片点击好以后，向表单内发送账户密码
browser.find_element_by_xpath('//*[@id="J-userName"]').send_keys('chenkai520')
browser.find_element_by_xpath('//*[@id="J-password"]').send_keys('chenkai19920308')
# 进行点击登录按钮
