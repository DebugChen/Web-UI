...
class MyTestCase_ZHHL_SBZLGL_Mbxz(unittest.TestCase):
    '''智慧护栏平台-设备资料管理模块-模板下载测试集'''
    ...
    @BeautifulReport.add_test_img('test_ZHHL_SBZLGL_Mbxz')
    def test_ZHHL_SBZLGL_Mbxz(self):
        '''设备资料管理模块-模板下载测试用例'''
        # 点击模板下载
...
if __name__=='__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_ZHHL_SBZLGL_Mbxz('test_ZHHL_SBZLGL_Mbxz'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='智慧护栏平台-设备资料管理模块-模板下载测试报告',
