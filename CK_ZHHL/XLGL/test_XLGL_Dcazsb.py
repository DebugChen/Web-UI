...
class MyTestCase_ZHHL_AZXLGL_Dcazsb(unittest.TestCase):
    '''智慧护栏平台-安装线路管理模块-导出安装设备测试集'''
    ...
    @BeautifulReport.add_test_img('test_ZHHL_AZXLGL_Dcazsb')
    def test_ZHHL_AZXLGL_Dcazsb(self):
        '''安装线路管理模块-导出安装设备测试用例'''
        # 点击导出安装设备按钮
...
if __name__ == '__main__':
    ...
    # 添加测试用例
    testunit.addTest(MyTestCase_ZHHL_AZXLGL_Dcazsb('test_ZHHL_AZXLGL_Dcazsb'))
    # 定义测试报告
    runner = BeautifulReport(testunit)
    runner.report(filename='智慧护栏平台-安装线路管理模块-导出安装设备测试报告',
